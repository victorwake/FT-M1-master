...
function cacheFunction(cb) {
  ...
  que recibe por parámetro (cb); es decir, que "recuerde" el resultado de cada 
  operación que hace, de manera que, al realizar una operación por segunda vez, se pueda obtener el resultado de 
  ...
  rgumento; hecho eso, debe guardar el argumento junto con el resultado de la invocación 
